    ...
    {!! Form::open(["url" => URL::current(), 'method' => "GET"]) !!}
        <div class="row bg_top">
            <div class="col-md-12 top_filter">
                ...
                @foreach($cities as $city)
                    @if($city->id == 2)
                        {!! Form::text('', isset($data["value_area".$city->id])? $data["value_area".$city->id] : old("amount-area_".$city->id, "Район"), ["id" => "amount-area_".$city->id, "readonly" => ""]) !!}
                    @else
                        {!! Form::text('', isset($data["value_area".$city->id])? $data["value_area".$city->id] : old("amount-area_".$city->id, "Район"), ["id" => "amount-area_".$city->id, "readonly" => "", "style" => "display: none;"]) !!}
                    @endif
                    <div id="area_{{$city->id}}_search" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-12 dop_select">
                ...
                {!! Form::text('', isset($data["value_rooms"])? $data["value_rooms"] : "Количество комнат", ['id'=>'amount-rooms', "readonly" => ""]) !!}
                <div id="rooms_search" style="display: none;">
                    <fieldset>
                        @if(isset($data["room"]))
                ...
                {!! Form::text('', isset($data["value_typeObj_2"])? $data["value_typeObj_2"] : "Вид обьекта", ['id'=>'amount-formObj_2', "readonly" => "", "style" => "display: none;"]) !!}
                <div id="formObj_2_search" style="display: none;">
                ...
                <input type="text" id="amount-square_2" readonly style="display: none;">
                <!-- Поля для поиска -->
                ...
                <div id="square_2_search" style="display: none;">
                ...
                <div id="square_1_search" style="display: none;">
                    <div id="slider-range-square_1"></div>
                </div>
                <input type="text" id="amount-square_earth" readonly style="display: none;">
                <!-- Поля для поиска -->
                ...
                <div id="square_earth_search" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-12 dop_select">
                ...
                <div id="floor_search" style="display: none;">
                    <div id="slider-range-floor"></div>
                </div>
                <input type="text" id="amount-floorInObj_2" readonly style="display: none;">
                <!-- Поля для поиска -->
                ...
                <div id="floorInObj_2_search" style="display: none;">
                ...
                <div id="floorInObj_1_search" style="display: none;">
                    <div id="slider-range-floorInObj_1"></div>
                </div>
                {!! Form::text('', isset($data["value_typeHouse_2"])? $data["value_typeHouse_2"] : "Материал стен", ['id'=>'amount-typeHouse_2', "readonly" => "", "style" => "display: none;"]) !!}
                <div id="typeHouse_2_search" style="display: none;">
                ...
                {!! Form::text('', isset($data["value_typeHouse_1"])? $data["value_typeHouse_1"] : "Тип дома", ['id'=>'amount-typeHouse_1', "readonly" => ""]) !!}
                <div id="typeHouse_1_search" style="display: none;">
                ...
                <input type="text" id="amount-distance" readonly style="display: none;">
                <!-- Поля для поиска -->
                ...
                <div id="distance_search" style="display: none;">
                    <div id="slider-range-distance"></div>
                </div>
                <input type="text" id="amount-price" readonly value="Цена, руб">
                <div id="price_search" style="display: none;">
                    {!! Form::number('price_min', isset($data["price_min"])? $data["price_min"] : old("price_min"), ['id'=>'min-price', "placeholder" => "от"]) !!}
                    <span style="float: left;">-</span>
                    {!! Form::number('price_max', isset($data["price_max"])? $data["price_max"] : old("price_max"), ['id'=>'max-price', "placeholder" => "до"]) !!}
                </div>
